...
### `scripts/visualize.py` / `scripts/visualize_chess_setup.py`

Open the MuJoCo viewer with the chess scene loaded. `visualize_chess_setup.py` additionally teleports all pieces to starting squares and shows the board.
