...
## Cleanup Refactor Testing Notes

`NoOpPhysicalExecutor` is the recommended stub for logic-only tests. `eval_game_logic.py` covers representative GameOrchestrator sequences without MuJoCo.
